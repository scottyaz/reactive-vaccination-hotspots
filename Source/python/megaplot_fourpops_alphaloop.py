...
spotconfig = "HCCC" # assuming we have one hotspot and 4 cold spots
...
for a in range(len(my_alphas)):
    ...
    for r in range(len_Rs):
        print ("\n R0 = %.2f, R1 = %.2f, R2 = %.2f, R3 = %.2f, scenario %s of %s" %
               (Rs0[r],Rs1[r],Rs2[r],Rs3[r],r,len_Rs))
        ins = vf.make_inputs(my_N,my_nlocs,
                             np.array([Rs0[r],Rs1[r],Rs2[r],Rs3[r]]),my_alpha)
